...
namespace NetCore.Data.Migrations
{
    ...
    [Migration("20220707100358_add-request-cert-user")]
    partial class addrequestcertuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCore.Data.Document", b =>
                {
                    ...
                    b.Property<string>("DocumentSignInfoJson")
                        .HasColumnName("document_sign_info")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ExportDocumentDataJson")
                        .HasColumnName("export_document_data")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsUseEverify")
                        .HasColumnName("is_use_everify")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("SignCloseAtDate")
                        .HasColumnName("sign_close_at_date")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("NetCore.Data.OrganizationConfig", b =>
                {
                    ...
                    b.Property<string>("ADSSProfileSignConfirm")
                        .HasColumnName("adss_profile_sign_confirm")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SignInfoDefaultJson")
                        .HasColumnName("sign_info_default_json")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("UseImagePreview")
                        .HasColumnName("use_image_preview")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("NetCore.Data.User", b =>
                {
                    ...
                    b.Property<string>("EKYCInfoJson")
                        .HasColumnName("ekyc_info_json")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsReceiveSignFailNoti")
                        .HasColumnName("is_receive_sign_fail_noti")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsReceiveSystemNoti")
                        .HasColumnName("is_receive_system_noti")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("NetCore.Data.UserHSMAccount", b =>
                {
                    ...
                    b.Property<string>("ChainCertificateBase64Json")
                        .HasColumnName("chain_certificate_base64_json")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("UserRequestCertJson")
                        .HasColumnName("user_request_cert_json")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("NetCore.Data.UserSignConfig", b =>
                {
                    ...
                    b.Property<string>("BackgroundImageFileBase64")
                        .HasColumnName("background_image_file_base64")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("NetCore.Data.Workflow", b =>
                {
                    ...
                    b.Property<bool>("IsSignOrgConfirm")
                        .HasColumnName("is_sign_org_confirm")
                        .HasColumnType("boolean");
                    ...
                    b.Property<Guid?>("NotifyConfigDocumentCompleteId")
                        .HasColumnName("notify_config_document_complete_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("NotifyConfigDocumentCompleteId");
            ...
            modelBuilder.Entity("NetCore.Data.WorkflowUserSign", b =>
                {
                    ...
                    b.Property<bool>("IsAllowRenew")
                        .HasColumnName("is_allow_renew")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int?>("MaxRenewTimes")
                        .HasColumnName("max_renew_times")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("NotifyConfigUserSignCompleteId")
                        .HasColumnName("notify_config_user_sign_complete_id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("SignCloseAfterDay")
                        .HasColumnName("sign_close_after_day")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("UserReceiveNotiExpireJson")
                        .HasColumnName("user_receive_noti_expire_json")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("NotifyConfigUserSignCompleteId");
            ...
            modelBuilder.Entity("NetCore.Data.Workflow", b =>
                {
                    b.HasOne("NetCore.Data.NotifyConfig", "NotifyConfigDocumentComplete")
                        .WithMany()
                        .HasForeignKey("NotifyConfigDocumentCompleteId");
                });
            ...
            modelBuilder.Entity("NetCore.Data.WorkflowUserSign", b =>
                {
                    ...
                    b.HasOne("NetCore.Data.NotifyConfig", "NotifyConfigUserSignComplete")
                        .WithMany()
                        .HasForeignKey("NotifyConfigUserSignCompleteId");
