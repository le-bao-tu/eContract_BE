...
namespace NetCore.Data.Migrations
{
    ...
    [Migration("20210923030429_add-wf-noti-config")]
    partial class addwfnoticonfig
    {
            ...
            modelBuilder.Entity("NetCore.Data.WorkflowStepExpireNotify", b =>
                {
                    ...
                    b.Property<TimeSpan>("TimeSendNotify")
            ...
            modelBuilder.Entity("NetCore.Data.WorkflowUserSign", b =>
                {
                    ...
                    b.Property<Guid?>("WorkflowStepExpireNotifyId")
                        .HasColumnName("workflow_step_expire_notify_id")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("WorkflowStepRemindNotifyId")
                        .HasColumnName("workflow_step_remind_notify_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkflowStepExpireNotifyId");

                    b.HasIndex("WorkflowStepRemindNotifyId");
            ...
            modelBuilder.Entity("NetCore.Data.WorkflowUserSign", b =>
                {
                    ...
                    b.HasOne("NetCore.Data.WorkflowStepExpireNotify", "WorkflowStepExpireNotify")
                        .WithMany()
                        .HasForeignKey("WorkflowStepExpireNotifyId");

                    b.HasOne("NetCore.Data.WorkflowStepRemindNotify", "WorkflowStepRemindNotify")
                        .WithMany()
                        .HasForeignKey("WorkflowStepRemindNotifyId");
                });
